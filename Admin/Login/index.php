				...
				if (mysqli_connect_errno()) {
					...
					if (!$resultadminlog) {
						...
						if (isset($_POST['Register'])) {
							...
							$sql = "INSERT INTO `AdminLogs` (`username`, `Password`, `Email`, `FullName`, `Telephone`) VALUES ('$User_Name', '$Pass_Word', '$E_Mail', '$Full_Name', '$Tele_Phone')
							";
							...
							if (isset($_POST['LogIn'])) {
								...
								$passwordhash = mysqli_real_escape_string($conn,$_POST['PassWord']);
								$sql = "SELECT * FROM AdminLogs WHERE username = '$User__Name'";
								$result = mysqli_query($conn, $sql);
